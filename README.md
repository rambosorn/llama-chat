...
Cambot AI is an **advanced RAG (Retrieval-Augmented Generation) Chatbot** designed for enterprise environments. It features a "Router & Expert" architecture that intelligently classifies user queries and routes them to specialized departmental agents (HR, Sales, Finance, IT) for accurate, context-aware answers.
